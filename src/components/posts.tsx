...
import { MDXFileData } from "@/lib/blog"
        ...
        const handleKeyDown = (e: KeyboardEvent) => {
            if (e.key === "/" && !isSearching) {
                ...
                setSelectedIndex((prev) => {
                    const isDownward = e.key === "ArrowDown" || ((e.ctrlKey || e.metaKey) && e.key === "j")
        ...
        <>
            ...
            <div className="space-y-8 sm:space-y-4">
                {filteredPosts.map((item, index) => (
                    ...
                    >
                        <PostItem post={item} isSelected={isSearching && index === selectedIndex} />
                    </div>
                ))}
            </div>
        </>
